...
export const NavBar = () => {
  ...
  return (
    <nav className='bg-indigo-500 rounded-t-3xl flex items-center justify-center h-16'>
        <ul className='text-xl text-white flex items-center justify-between gap-8'>
            <li className=''>
            ...
            <li className='bg-indigo-500 rounded-full -translate-y-3'>
